...
def tutorial():
    os.system('cls')
    print('Para prosseguir para a próxima tela, precione ENTER para continuar\n\n')
    input('Olá, boa Tarde!\nSeja bem vindo(a) NOME, ao Serviço de Quarto virtual do Saint Patrick Grand Hotel! (...)')
    os.system('cls')

    input('Me chamo Fernando e serei seu assistente virtual\ndurante sua estadia no nosso hotel! (...)')
    os.system('cls')

    input('Este é seu canal de comunicação direto com os nossos funcionários do Hotel (...)')
    os.system('cls')
